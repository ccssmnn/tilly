...
export function VirtualizedList<T>({
	...
	let virtualizer = useWindowVirtualizer({
		...
		measureElement: (element, entry, instance) => {
			// When ResizeObserver fires (entry defined), always measure fresh
			// so dynamic content changes (expand/collapse) are picked up.
			// Only use backward-scroll cache for initial measurements.
			if (!entry && instance.scrollDirection === "backward") {
