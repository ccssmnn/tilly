...
export { ReminderCreateResult }

type AddReminderToolUI = InferUITool<ReturnType<typeof createAddReminderTool>>

function ReminderCreateResult({
	result,
	addMessage,
}: {
	result: AddReminderToolUI["output"]
		...
		return (
			<ToolMessageWrapper icon={Notification01Icon}>
				<span className="text-gray-500 line-through">
					<T k="tool.reminder.created.undone" params={{ text: textPreview }} />
				</span>
			</ToolMessageWrapper>
		)
	}
	...
	return (
		<ToolMessageAccordion
			...
			summary={
				<T k="tool.reminder.created.message" params={{ text: textPreview }} />
			}
			content={
