...
const basePeopleMessages = messages({
	...
	"person.detail.search.placeholder": "Search...",
	...
	"person.actions.delete": "Delete",
	"person.actions.addNote": "Add Note",
	"person.actions.addReminder": "Add Reminder",
	"person.restore.button": "Restore",
	"person.toast.deleted": "{$name} has been deleted",
...
const dePeopleMessages = translate(basePeopleMessages, {
	...
	"person.detail.pageTitle": "{$name}",
	"person.detail.search.placeholder": "Suchen...",
	...
	"person.actions.delete": "Löschen",
	"person.actions.addNote": "Notiz hinzufügen",
	"person.actions.addReminder": "Erinnerung hinzufügen",
	"person.restore.button": "Wiederherstellen",
	"person.toast.deleted": "{$name} wurde gelöscht",
