...
const baseRemindersMessages = messages({
	...
	"reminder.status.deleted": "Deleted {$relativeTime}",
	"reminder.status.done": "Done {$relativeTime}",
...
const deRemindersMessages = translate(baseRemindersMessages, {
	...
	"reminder.status.deleted": "{$relativeTime} gelöscht",
	"reminder.status.done": "{$relativeTime} erledigt",
